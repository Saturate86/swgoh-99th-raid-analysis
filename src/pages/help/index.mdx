...
<Card title="Understanding the Data" icon="📊">
  ...
  ## Color Coding
  - 🟢 **Green**: Good to Outstanding performance (95%+ of estimated score)
    - Light Green: Good (95-105%)
    - Green: Very Good (105-115%)  
    - Dark Green: Outstanding (&gt;115%)
  - 🟡 **Yellow**: Average performance (80-95% of estimated score)
  - 🟠 **Orange**: Below average performance (70-80% of estimated score)
  - 🔴 **Red**: Poor performance (&lt;70% of estimated score)
